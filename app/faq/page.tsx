...
export default function FAQ() {
  ...
  const categorizedFAQs = {
    attendance: [
      ...
      {
        id: 3,
        question: language === 'ko' ? "행사 참가비는 얼마인가요?" : "What is the participation fee for the event?",
        answer: language === 'ko' ? "별도의 참가비는 없습니다." : "There is no separate participation fee."
      },
      {
        id: 4,
